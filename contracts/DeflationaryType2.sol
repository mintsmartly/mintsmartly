...
contract MintSmartly is Context, IERC20, Ownable,Pausable {
    ...
    uint256 private _previousLiqudityFee;
    ...
    constructor (address _router,uint256 _time) public {
         expiryTime = _time;
    ...
    function init(
        ...
        _liquidityFee = liqudityFee;
        _previousLiqudityFee = _liquidityFee;
        _tTotal = supply;
    ...
    function setliqudityFeePercent(uint256 liqudityFee) external onlyOwner() {
        _liquidityFee = liqudityFee;
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 tLiquidity = calculateliqudityFee(tAmount);
    ...
    function calculateliqudityFee(uint256 _amount) private view returns (uint256) {
    ...
    function restoreAllFee() private {
        ...
        _liquidityFee = _previousLiqudityFee;
    }
